      ...
      <el-card>
        <el-tabs>
          ...
          <el-tab-pane alo label="公司信息">
            ...
            <el-alert type="info" :show-icon="true" :closable="false" title="对公司名、公司地址、营业执照、公司地区的更新，将使得公司资料被重叠审核，请谨慎修改" />
            <el-form
              label-width="120px"
    ...
    >
      ...
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          ...
          <el-button size="small" @click="btnPermCance">取消</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    async  btnPermOK() {
      ...
      this.showPermDialog = false // 关闭弹层
    },
    btnPermCance() {
